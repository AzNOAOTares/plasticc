...
def get_feature_names(passbands, ignore=()):
    ...
    cesium_fields = sum([['cesium_flux_percentile_ratio_mid20_%s' % p, 'cesium_flux_percentile_ratio_mid50_%s' % p,
                          ...
                          'cesium_freq2_amplitude4_%s' % p, 'cesium_freq2_rel_phase2_%s' % p,
                          'cesium_freq2_rel_phase3_%s' % p, 'cesium_freq2_rel_phase4_%s' % p,
                          'cesium_freq3_amplitude1_%s' % p, 'cesium_freq3_amplitude2_%s' % p,
                          'cesium_freq3_amplitude3_%s' % p, 'cesium_freq3_amplitude4_%s' % p,
                          ...
                          'cesium_freq_amplitude_ratio_31_%s' % p, 'cesium_freq_n_alias_%s' % p,
